...
class Residential(ConsumerCategory):
    def __init__(self,consumer,slab_rate,solar_system_obj,energy_generation_obj,
        ...
        self.annual_maintenance_ratio=RESIDENTIAL_CONFIG["annual_maintenance_cost"]
...
class ResidentialFinance():
    ...
    def get_gross_cost(self):
        return self.r_obj.l_obj.calculate_system_capacity() *self.r_obj.market_rate_per_kW
    
    def get_net_investment(self):
        return self.get_gross_cost() - self.r_obj.l_obj.get_combined_subsidy()
          
    def get_monthly_savings(self):
        return self.r_obj.eg_obj.monthly_energy() *self.r_obj.slab_rate
    ...
    def get_total_lifetime_cost(self):
        return self.get_net_investment() + ((self.get_net_investment()*self._obj.annual_maintenance_ratio)*self.r_obj.life)
    ...
    def get_lifetime_energy_generation(self):
        return self.r_obj.eg_obj.annual_energy() *self.r_obj.life
...
class CommercialFinance():
    ...
    def get_base_system_cost(self):
        return self.c_obj.l_obj.get_system_capacity() *self.c_obj.market_rate_per_kW
