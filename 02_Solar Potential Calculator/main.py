...
def create_commercial_obj(gst_input_credit,solar_system_obj,energy_generation_obj,location_obj,utils_obj):
    return  Commercial(gst_input_credit,solar_system_obj,energy_generation_obj,location_obj,utils_obj)
...
def take_object_inputs():
    ...
    while True:
        ...
        if city not in CITY_LATITUDE.keys():
